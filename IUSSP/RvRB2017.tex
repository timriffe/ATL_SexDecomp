...
\begin{overprint}
\begin{center}
\only<1>{\includegraphics[trim=1cm 0 0 0, clip,width=1.1\linewidth]{Figures/schematic_pres0.pdf}}
\only<2>{\includegraphics[trim=1cm 0 0 0, clip,width=1.1\linewidth]{Figures/schematic_pres1.pdf}}
\only<3>{\includegraphics[trim=1cm 0 0 0, clip,width=1.1\linewidth]{Figures/schematic_pres2.pdf}}
\only<4>{\includegraphics[trim=1cm 0 0 0, clip,width=1.1\linewidth]{Figures/schematic_pres3.pdf}}
\end{center}
\end{overprint}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
