...
%\documentclass[12pt,oneside,letterpaper,doublespacing]{article}  % for submission
...
%\usepackage{natbib}
\usepackage[natbibapa]{apacite}% for submission
...
\usepackage{amsfonts}
\usepackage{xfrac}
\usepackage[notablist,nofiglist]{endfloat} % for submission
\renewcommand{\figurename}{Fig.} % for submission
...
Age structure \pagebreak % for submission
...
\bibliographystyle{apacite} % for submission
\bibliography{refs}
