...
Estimating morbidity prevalence by time-to-death is straightforward for health surveys with mortality follow-up modules. We use the RAND version P of the U.S. Health and Retirement Study (HRS), which is sponsored by the National Institute on Aging (grant number NIA U01AG009740) and is conducted by the University of Michigan. The harmonized RAND dataset includes a total of 12 survey waves from 1992 through 2014 and an extensive set of measures for various aspects of morbidity. Time-to-death is recorded directly for deceased respondents as the difference between the date of death and interview date, and time-to-death trajectories of health measures are therefore directly available as such in the data.


\begin{itemize}
\item{This is what we need}
\item{data}
\item{setup, variables}
\item{glm bootstrap smoothing}
\item{surfaces and simplification to ttd patterns}
\end{itemize}
