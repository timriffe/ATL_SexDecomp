...
in addition to a life table. Specifically, the
number of person-years with disability $_{n}\pi _{x} \times _{n}L _{x}$ in
...
of these components as pure mortality and morbidity effects. If the time-to-death
...
prevalence of morbidity is applied to different mortality regimes using empirical data. %Morbidity data come from the US Health and Retirement Study while mortality and exposure data come from the Human Mortality Database \citep{HMD2018}.
