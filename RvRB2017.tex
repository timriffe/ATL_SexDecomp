...
how well a 1-dimensinoal TTD pattern describes its underlying joint age by TTD prevalence pattern, the extent to which the US average TTD prevalence is representative, and the departure from the stationary population assumption.
...
chronological age or time to death, or whether morbidity prevelance is derived from a multistate incidence-based model. However, difficulties arise in the
interpretation of period differences in HLE. The age
pattern of disability prevalance can increase or decrease solely as a function of mortality
...
observation gives an alternative to the practice of forecasting observed
...
disability transition rates. The cohort-period direction of difference in ALE is consistent with a fixed TTD pattern combined with improving mortality, as of our toy example in Section~\ref{sec:morb}. We hypothesize that some of these
...
as a function of both age and time until death can increase precision
\citep{klijs2011future, wolf2015disability,riffe2017ttd}.
